...
export default class ManageClient extends React.Component {
    ...
    // loadData url: 'https://service-profile-task.azurewebsites.net/profile/profile/getClientList',
    //deleteClient  url: 'https://service-identity-task.azurewebsites.net/authentication/authentication/deactivateClientAccount?id=' + clientId,
